export const classes = [
  ...
  {
    slug: "ten-plus-two-class-package",
    type: "Package",
    name: "10+2 Class Package",
    description:
...
export const packages = [
  ...
  },
  {
    ...
    priceLabel: "$400",
    description:
      "A practical package for clients who want structure, consistency, and measurable progress.",
  ...
  },
  {
    ...
    features: ["12 total classes", "High-commitment option", "Built for progression"],
    mode: "payment",
